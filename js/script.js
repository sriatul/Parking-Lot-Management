...
class Entry{
    constructor(owner,vehicle,licensePlate,entryDate,exitDate){
        this.owner = owner;
...
class UI{
    ...
    static validateInputs(){
        ...
        if(owner === '' || vehicle === '' || licensePlate === '' || entryDate === '' || exitDate === ''){
...
//Event Add
    document.querySelector('#entryForm').addEventListener('submit',(e)=>{
        ...
        //Instatiate Entry
        const entry = new Entry(owner, vehicle, licensePlate, entryDate, exitDate);
